                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{route('ktps.edit', $a->id)}}">Edit</a>
                                        <a class="dropdown-item" href="{{route('ktps.show', $a->id)}}">Lihat Detail</a>
                                        <a class="dropdown-item" onclick="event.preventDefault(); document.getElementById('destroy-form').submit();">Hapus</a>
                                        <form id="destroy-form" action="{{ route('ktps.destroy', $a->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                          </form>
                                    </div>
