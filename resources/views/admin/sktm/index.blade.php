                    ...
                    @foreach ($collection as $key => $a)
                        <tr>
                            ...
                            <td>
                                ...
                                @else 
                                    <a href="{{route('sktms.edit', $a->id)}}" class="btn btn-sm btn-danger">Belum ACC</a>
                                @endif
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('sktms.show', $a->id) }}">Lihat Detail</a>
                                        <a class="dropdown-item"
                                            onclick="event.preventDefault(); document.getElementById('destroy-form').submit();">Hapus</a>
                                        <form id="destroy-form" action="{{ route('sktms.destroy', $a->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
