...
class KematianController extends Controller
{
    ...
    {
        $collection = Kematian::where('user_id', Auth::user()->id)->get();
        return view('user.kematian.index', compact('collection'));
    }
    ...
    {
        return view('user.kematian.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->status = 0;
        $data->save();
        return redirect()->route('Kematian.index')->with('success','Data Berhasil Ditambah!');
    }
    ...
    public function show($id)
    {
        ...
        return view('user.kematian.detail',compact('data','kades'));
    }
    ...
    {
        $data = Kematian::find($id);
        return view('user.kematian.edit', compact('data'));
    }
